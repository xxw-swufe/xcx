<template>
	<view class="page">
		<view class="nav-header">
			...
			<text class="nav-title-right">管行宝</text>
		</view>
		...
		<scroll-view class="content" scroll-y>
			...
			<view class="order-card">
				...
				<view class="order-row">
					<text class="order-label">会员类型</text>
				...
				<view class="order-row">
					<text class="order-label">有效期至</text>
			...
			<view class="tip-area">
				...
				<text class="tip-text">发票申请可在“我的订单”-“开票历史”中进行操作。如有疑问请联系在线客服。</text>
			</view>
		</scroll-view>
